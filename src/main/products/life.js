        ...
        <div className='l extraPadding'>
            <div>
                ...
                <ul>
                    ...
                    <li>Indexed Life</li>
                    <li>Impaired Life</li>
                    <li>Guarantee and simplified issue</li>
                    <li>Small group life</li>
                </ul>     
                <div>
            ...
            <div>
                ...
                <a href="http://advisor.allegisag.com/forms/life-insurance-illustration-request" target="_blank" rel='noopener noreferrer'>Life Insurance Quote</a>     
            </div>
        </div>
    );
};
